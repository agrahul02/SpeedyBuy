...
public class AdapterChatList extends RecyclerView.Adapter<AdapterChatList.Myholder> {
    ...
    public AdapterChatList(FragmentActivity activity, List<ModelUsers> usersList, HashMap<String, String> lastMessageMap) {

    }

    public AdapterChatList(FragmentActivity activity, List<ModelChatList> chatListList) {
    }
    ...
    public void onBindViewHolder(@NonNull Myholder holder, final int position) {
        ...
        holder.block.setImageResource(R.drawable.ic_add_black_24dp);
