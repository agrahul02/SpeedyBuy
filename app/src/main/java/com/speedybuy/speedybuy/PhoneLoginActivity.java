...
public class PhoneLoginActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPhone = findViewById(R.id.idEdtPhoneNumber_up);
        edtOTP = findViewById(R.id.idEdtOtp_up);
        verifyOTPBtn = findViewById(R.id.idBtnVerify_up);
        generateOTPBtn = findViewById(R.id.idBtnGetOtp_up);
        alredyHaveAnAccount = findViewById(R.id.tv_alredy_have_an_account_n);
        closeBtn = findViewById(R.id.sign_up_close_btnn);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        // setting onclick listener for generate OTP button.
        closeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(PhoneLoginActivity.this, MainActivity.class);
        ...
        alredyHaveAnAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(PhoneLoginActivity.this, RegisterActivity.class);
                startActivity(myIntent);
            }
        });
